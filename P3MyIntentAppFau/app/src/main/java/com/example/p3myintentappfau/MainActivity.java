package com.example.p3myintentappfau;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Fauziah Syifa R. Siregar");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 19);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Fauziah Syifa R. Siregar");
                mPerson.setAge(19);
                mPerson.setEmail("fauziah@upnvj.ac.id");
                mPerson.setCity("Jagakarsa");
